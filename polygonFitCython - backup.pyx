...
def pologonFit(np.ndarray originalPoints, double actureArea, int imagePath = 0, int iterationLimit = 10, double alphaMean = 5, double alphaStd = 2, int direction = -1):
    '''
    Parameters
